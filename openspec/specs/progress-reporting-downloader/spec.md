# Capability: progress-reporting-downloader

## Purpose

Specifies multi-stage progress reporting and download progress feedback for Gradle documentation tasks, with decoupled service-to-MCP bridging.
