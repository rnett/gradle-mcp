# Capability: dependency-tool-pagination

## Purpose

Specifies pagination support for the `inspect_dependencies` tool, covering both full dependency trees and update-only summaries.
