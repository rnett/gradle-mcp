# Capability: dependency-source-reliability

## Purpose

Ensures dependency source tools never hang indefinitely by enforcing deterministic timeouts, cancellation support, and diagnostic feedback for all long-running operations.
