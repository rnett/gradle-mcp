# Capability: progress-percentage

## Purpose

Defines phase-based progress calculation, smooth interpolation using StatusEvent data, and graceful handling of unknown work totals.
