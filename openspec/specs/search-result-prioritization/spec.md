# Capability: search-result-prioritization

## Purpose

Ensures exact, case-sensitive matches are ranked higher than partial matches in full-text search results through multi-field indexing strategies.
