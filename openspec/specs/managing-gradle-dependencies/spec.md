...
Defines the `managing_gradle_dependencies` skill, which covers the complete dependency management lifecycle: auditing graphs, checking for updates, discovering versions, adding dependencies, and verifying plugin resolution.
