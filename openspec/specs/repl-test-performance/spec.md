# Capability: repl-test-performance

## Purpose

Specifies that REPL integration tests must share environments across test methods and use minimal test projects to reduce overhead.
