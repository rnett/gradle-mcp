# Capability: tool-description-tuning

## Purpose

Establishes standards for tuning MCP tool descriptions to improve agent tool selection accuracy through discriminative language, cross-referencing, and clear parameter auto-detection boundaries.

## Requirements

### Requirement: Discriminative Tool Descriptions

Each tool description MUST include explicit discriminative language that distinguishes it from related tools. Descriptions MUST include both positive triggers ("Use for...") and negative triggers ("Do NOT use for...") that reference specific alternative tools by name.
