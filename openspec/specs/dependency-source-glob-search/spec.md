# Capability: dependency-source-glob-search

## Purpose

Enables searching for any file within dependency source trees using standard glob patterns, providing high-signal snippets and leveraging persistent indices for performance.
