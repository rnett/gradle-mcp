# Capability: in-progress-tests

## Purpose

Tracks tests that have started but not yet finished during a Gradle build, and reports them appropriately on build completion or cancellation.
