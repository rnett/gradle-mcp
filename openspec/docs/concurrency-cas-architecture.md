...
* **Immutability:** Once written to the CAS cache (`.cache/cas/<hash>`), a directory is **never modified**.
...
|:-----------------------|:---------------------------------------|:---------------------------------------------|:--------------|
| **Global CAS Cache**   | `~/.mcp/cas/sha256-a1b2c3d4/`          | Extracted sources & Lucene indices.          | **Immutable** |
