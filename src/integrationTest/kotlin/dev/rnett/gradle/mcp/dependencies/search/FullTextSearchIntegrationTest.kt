...
class FullTextSearchIntegrationTest : SearchIntegrationTestBase() {
    ...
    fun `test full text search across mocked dependencies`() = runTest {
        ...
        assertTrue(resultsA.any { it.relativePath == "deps/depA/1.0/example/FileA.kt" && it.line == 3 }, "phrase in FileA missing at line 3: ${resultsA}")
        ...
        assertTrue(resultsB.any { it.relativePath == "deps/depB/2.0/other/FileB.java" && it.line == 4 }, "phrase in FileB missing at line 4: ${resultsB}")
        ...
        assertEquals(setOf("deps/depA/1.0/example/FileA.kt", "deps/depB/2.0/other/FileB.java"), files)
    }
