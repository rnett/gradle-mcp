...
## Explanation
Sometimes you may need to [exclude transitive dependencies (Use `gradle_docs(path="userguide/how_to_exclude_transitive_dependencies.md")`.) that cause conflicts or issues in your project.  
...
## References
* [Excluding Transitive Dependencies (Use `gradle_docs(path="userguide/resolution_rules.md")`.)
