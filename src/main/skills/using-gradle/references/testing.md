...
**More info**: Test filtering and reports: `gradle_docs` `tag:userguide test filtering`, path `userguide/java_testing.md`; test diagnostics: `query_build(kind="TESTS")` via https://gradle-mcp.rnett.dev/latest/tools/LOOKUP_TOOLS/.
